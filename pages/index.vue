      ...
      <div>
        <div class="relative w-full sm:w-2/3 lg:w-1/2 z-10">
          <h1 class="text-3xl lg:text-4xl xl:text-5xl leading-tight font-bold">
            Fair Rate lets you find the fairrest
            rate.
          </h1>
            ...
            <g transform="translate(1950.456 5248.5)">
              ...
              <g transform="translate(-1159.5 -5243.5)">
                ...
                <g transform="translate(13 15)">
                  <path d="M8,0,0,9H15L8,0" transform="translate(6)" fill="#95cdb1" /><text
    ...
    <section class="relative bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-20 text-center">
      ...
      <div class="flex flex-col md:flex-row items-start justify-between mt-12">
        <div class="w-full bg-white shadow-lg rounded-lg px-4 py-6 lg:p-8 md:mx-2 lg:mx-4">
          ...
          <h4 class="text-xl font-bold leading-tight mt-8">
      ...
      <div class="mt-12 md:mt-20 w-full md:max-w-3xl mx-auto">
        <p class="text-xl">
          &ldquo;FairRate is beautiful, elegant and easy to apply. I’ve been able to apply for an
          amazing rate in just a minutes. Thank you very much for creating this impressive service!&rdquo;
        </p>
        <p class="text-xl font-bold text-blue-600 mt-4">
          Valeria Boltneva
        </p>
        <p class="text-sm uppercase tracking-wider text-gray-700">
    ...
    <section class="relative bg-blue-600 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-20 pb-40">
      ...
      <div class="flex flex-col md:flex-row mt-12 items-center justify-between">
        ...
        <div class="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
          ...
          <p class="text-white leading-snug mt-2">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between bg-blue-300 px-12 py-10 rounded-lg shadow-lg">
        <div class="w-full md:w-2/3">
          ...
          <p class="mt-2 md:max-w-md">
            Contact our Customer Support that is always ready to help you with any possible questions, problems or
            information.
          </p>
        </div>
    ...
    <footer class="relative bg-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-12 pb-10 text-center sm:text-left">
      <div class="flex flex-col sm:flex-row sm:flex-wrap">
        <div class="sm:w-1/2 lg:w-1/5">
          <h6 class="text-sm text-gray-600 font-bold uppercase">
            Company
          </h6>
          <ul class="mt-4">
        ...
        <div class="mt-12 sm:w-1/2 lg:w-2/5 lg:mt-0 lg:pl-12">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="188" height="39" class="mx-auto sm:mx-0">
              <text
                transform="translate(87 29)"
                fill="#454f5b"
              >
      ...
      <div class="mt-16">
        ...
        <p class="text-sm text-gray-600">
          2019 © FairRate. All rights reserved.
        </p>
      </div>
    </footer>
    <!-- end footer -->
